...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a class="list-group-item list-group-item-action list-group-item-light p-3 active" href="quarterly.php">Quarterly Report</a>
                <a class="list-group-item list-group-item-action list-group-item-light p-3 " href="../branches/branches.php">Branches</a>
                <a class="list-group-item list-group-item-action list-group-item-light p-3" href="../courses/courses.php">Courses</a>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <table id="quarterly_data" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <td> Branch ID</td>
                                        <td>Quarter</td>
    ...
    <script type="text/javascript" language="javascript" src="quarterly.js"> </script>
